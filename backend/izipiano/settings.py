"""
Django settings for izipiano project.
...
SECRET_KEY = 'django-insecure-w8oz1z9qf29qi29i%t!pyzqpjyi5h=e3bg^eh6s%rlao1=y(7d'
...
WSGI_APPLICATION = 'izipiano.wsgi.application'
...
# 사장님 연락처 (요청사항 알림용)
OWNER_PHONE = "01027218540"  # 사장님 번호로 바꿔야함 
